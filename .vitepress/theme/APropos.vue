<template>
  <section class="text-blue-dark flex flex-col items-center pb-8">
    ...
    <p class="text-center mt-8 px-8"><strong class="font-extrabold text-xl">Grâce à une solution saine et souveraine !</strong></p>
  </section>
  <section class="bg-blue px-8 pt-8 flex flex-col items-center">
    ...
    <div class="border-t-2 border-e-2 border-blue-light mt-12 -ms-8 pt-8 relative">
      <div class="bg-blue-dark text-white p-8 transform">
        ...
        <p>Nous souhaitons <strong>simplifier le métier</strong> de l’assurance pour lui permettre de se recentrer sur ses missions à impact. Nous cherchons à privilégier le “care”, en prenant en charge les aspects techniques, sécurité, automatisation. Parce que l’important, finalement c’est l’utilisateur final, et nous voulons donner l’opportunité <strong>aux acteurs du secteur de se recentrer</strong> autour de lui.</p>
      </div>
      <img src="/assets/images/dot_teal.svg" alt="" class="w-3 absolute -bottom-2 -right-1.5">
    </div>
  </section>
  <section class="p-8">
  ...
  <section>
    <img src="/assets/images/stan_working.jpg" alt="Les équipes de Stan travaillant autour d'une table dans les locaux de l'entreprise">
  </section>
  ...
  <section class="-mt-44 px-8 team team border-b-2 border-blue">
    <div>
  ...
  <section class="bg-blue pt-40 flex flex-col">
    ...
    <div class="bg-white w-2/3 pt-6 ps-8 pe-10 pb-8 relative z-10">
    ...
    <div class="bg-blue-dark ms-8 px-6 pt-24 pb-8 -mt-16">
      <ul class="arrow-list">
